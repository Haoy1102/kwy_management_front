                    ...
                    <template slot-scope="props">
                        <el-form label-position="left" inline class="demo-table-expand">
                            ...
                            <el-form-item label="发货日期 ">
                                <span>{{ props.row.deliveredDate }}</span>
                            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        //获取页面
        getPage() {
            http.get(`/products/records/${this.pageData.currentPage}/${this.pageData.pageSize}/?id=${this.pageData.id}&productName=${this.pageData.productName}&productCode=${this.pageData.productCode}&batchId=${this.pageData.batchId}&orderId=${this.pageData.orderId}&customer=${this.pageData.customer}`)
                .then(({data}) => {
                        if (!data.code) {
